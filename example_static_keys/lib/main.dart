...
void main() async {
  var delegate =
      await LocalizationDelegate.create(fallbackLocale: 'en_US', supportedLocales: ['en_US', 'es', 'fa', 'ar']);
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(translate(Keys.Language_Selected_Message, args: {
              'language': translate(getCurrentLanguageLocalizationKey(localizationDelegate.currentLocale!.languageCode))
            })!),
            Padding(
            ...
            Padding(
                padding: const EdgeInsets.only(bottom: 10), child: Text(translatePlural(Keys.Plural_Demo, _counter)!)),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                IconButton(
